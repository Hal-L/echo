                        ...
                        <div class="form-group form-inline">
                            <div class="btn-group">
                                <button type="button" class="btn btn-default" title="新建"
                                        onclick='location.href="${ctx}/store/question?operation=toAdd"'>
                                    <i class="fa fa-file-o"></i> 新建
                                </button>
                                <button type="button" class="btn btn-default" title="测试文件上传"
                                        onclick='location.href="${ctx}/store/question?operation=toTestUpload"'>
                                    <i class="fa fa-file-o"></i> 测试文件上传
                                </button>
                                ...
                                <button type="button" class="btn btn-default" title="导出题目"
                                        onclick=location.href="${ctx}/store/question?operation=downloadReport">
                            ...
                            <tr class="odd" onmouseover="this.className='highlight'"
                                ...
                                <th class="text-center">
                                    <button type="button" class="btn bg-olive btn-xs"
                                            onclick='location.href="${ctx}/store/question?operation=toEdit&id=${o.id}"'>编辑
                                    </button>
                                        <%-- onclick绑定的值请求的是QuestionItermServlet，
                                        传递的参数是questionId，所以建议把请求参数修改为questionId，避免对之后的业务理解产生影响 --%>
                                    <button type="button" class="btn bg-olive btn-xs"
                                            onclick='location.href="${ctx}/store/questionItem?operation=list&questionId=${o.id}"'>配置选项
                                    </button>
                                    <button type="button" class="btn bg-olive btn-xs"
