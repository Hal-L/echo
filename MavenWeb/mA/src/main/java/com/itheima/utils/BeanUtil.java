...
public class BeanUtil {
	...
	public static <T> T fillBean(HttpServletRequest request, Class<T> clazz) {
		System.out.println("j-utils-BeanUtil-!!!-fillBean--"+request+"+++"+clazz);
	...
	public static <T> T fillBean(HttpServletRequest request,Class<T> clazz,String datePattern){
		System.out.println("j-utils-BeanUtil-!!!-fillBean--"+request+"+++"+clazz+"+++"+datePattern);
		//1.定义一个T类型的javabean
		T bean = null;
		try{
			//2.实例化bean对象
	...
	public static <T> T fillBean(List<FileItem> items,Class<T> clazz){
		System.out.println("j-utils-BeanUtil-!!!-fillBean--"+items+"+++"+clazz);
		//1.定义一个T类型的javabean
		T bean = null;
		try{
			//2.实例化Bean
