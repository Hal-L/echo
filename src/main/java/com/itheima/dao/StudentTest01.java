...
public class StudentTest01 {
    ...
    public void delete() throws Exception {
        //1.加载核心配置文件
        InputStream is = Resources.getResourceAsStream("com/MyBatisConfig.xml");
    ...
    public void selectAll() throws Exception {
        ...
        InputStream is = StudentTest01.class.getClassLoader().getResourceAsStream("com/MyBatisConfig.xml");
