...
​ static ExecutorService newCachedThreadPool()   创建一个默认的线程池 static newFixedThreadPool(int nThreads)
创建一个指定最多线程数量的线程池
...
public class AtomDemo {
    public static void main(String[] args) {
        KnowledgePoints.多线程.mythreadatom.src.com.itheima.threadatom.MyAtomThread atom = new KnowledgePoints.多线程.mythreadatom.src.com.itheima.threadatom.MyAtomThread();
...
public class AtomDemo {
    public static void main(String[] args) {
        KnowledgePoints.多线程.mythreadatom.src.com.itheima.threadatom2.MyAtomThread atom = new KnowledgePoints.多线程.mythreadatom.src.com.itheima.threadatom2.MyAtomThread();
...
​    **Hashtable出现的原因 :** 在集合类中HashMap是比较常用的集合对象，但是HashMap是线程不安全的(多线程环境下可能会存在问题)
