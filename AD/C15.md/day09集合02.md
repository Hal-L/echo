...
- 泛型通配符的使用
  ...
  public class GenericDemo4 {
      ...
      // 泛型的上限: 此时的泛型<?>必须是Number类型或者Number类型所有的子类类型
      public static void getElement1(ArrayList<? extends Number> list){}
      // 泛型的下限: 此时的泛型<?>必须是Number类型或者Number类型的父类类型
...
- 代码实现
  ...
  老师类https://editor.csdn.net/md?articleId=107967515
