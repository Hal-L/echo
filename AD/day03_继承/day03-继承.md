...
+ 代码实现
  ...
  // Student类
  public class D5.DemoTostring.Student extends Person {
      public D5.DemoTostring.Student() {
      }

      public D5.DemoTostring.Student(String id, String name, String age, String birthday) {
  ...
  public abstract class BaseStudentController {
      ...
      public void updateStudent() {
          ...
          D5.DemoTostring.Student newStu = inputStudentInfo(updateId);
      ...
      public void findAllStudent() {
          ...
          D5.DemoTostring.Student[] stus = studentService.findAllStudent();
          // 2. 判断数组的内存地址, 是否为null
          if (stus == null) {
          ...
          for (int i = 0; i < stus.length; i++) {
              D5.DemoTostring.Student stu = stus[i];
              if (stu != null) {
      ...
      public void addStudent() {
          ...
          D5.DemoTostring.Student stu = inputStudentInfo(id);
    ...
    public D5.DemoTostring.Student inputStudentInfo(String id){
      return null;
    }
  }
  ```
  ...
  public class OtherStudentController extends BaseStudentController {
      ...
      public D5.DemoTostring.Student inputStudentInfo(String id) {
          ...
          System.out.println("请输入学生生日:");
          String birthday = sc.next();
          D5.DemoTostring.Student stu = new D5.DemoTostring.Student(id,name,age,birthday);
          return stu;
      }
  }
  ```
...
- final修饰类、方法、变量的效果
    ...
    - final修饰变量：表明该变量是一个常量，不能再次赋值
        ...
        + 举例
          ...
          ```java
          public static void main(String[] args){
              final D5.DemoTostring.Student s = new D5.DemoTostring.Student(23);
                s = new D5.DemoTostring.Student(24);  // 错误
               s.setAge(24);  // 正确
          }
          ```
...
+ 代码实现
  ...
  public abstract class BaseStudentController {
      ...
      // 键盘录入学生信息
      // 开闭原则: 对扩展内容开放, 对修改内容关闭
    public abstract D5.DemoTostring.Student inputStudentInfo(String id);
  }
  ```
    ...
    + 示例代码
      ...
      public class Test22 {
          ...
          public static void main(String[] args) {
              ...
              D5.DemoTostring.Student stu2 = new D5.DemoTostring.Student(10);
          }
      }
      ...
      class D5.DemoTostring.Student {
          ...
          public D5.DemoTostring.Student(int a){
...
+ 示例代码
  ...
  public class StudentDao {
      // 创建学生对象数组
      private static D5.DemoTostring.Student[] stus = new D5.DemoTostring.Student[5];
      ...
      public boolean addStudent(D5.DemoTostring.Student stu) {
          ...
          for (int i = 0; i < stus.length; i++) {
              D5.DemoTostring.Student student = stus[i];
              if(student == null){
                  index = i;
