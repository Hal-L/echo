...
hhh、打开命令行窗口的方式：win + r打开运行窗口，输入cmd，回车。
...
| cd ..              | 回退到上一级目录。                |
| cd 目录1\目录2\... | 进入多级目录。cd KnowledgePoints.myInterface.interFalse\JavaSE   |
| cd \               | 回退到盘符目录。                  |
| cls                | 清屏。                            |
| exit               | 退出命令提示符窗口。              |
...
#### 2.3.hhh Java程序开发运行流程

开发Java程序，需要三个步骤：编写程序，编译程序，运行程序。

#### 2.3.2 HelloWorld案例的编写

hhh、新建文本文档文件，修改名称为HelloWorld.java。
...
|          | short        | 2        | -32768~32767                                                                                                                       |
|          | int(默认)    | 4        | -2的31次方到2的31次方-hhh                                                                                                            |
|          | long         | 8        | -2的63次方到2的63次方-hhh                                                                                                            |
| 浮点类型 | float        | 4        | 负数：-3.402823E+38到-hhh.401298E-45                                                             正数：   hhh.401298E-45到3.402823E+38 |
|          | double(默认) | 8        | 负数：-hhh.797693E+308到-4.9000000E-324                                              正数：4.9000000E-324   到1.797693E+308          |
| 字符类型 | char         | 2        | 0-65535                                                                                                                            |
...
hhh、导包。Scanner 类在java.util包下，所以需要将该类导入。导包的语句需要定义在类的上面。
